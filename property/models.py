...
class Flat(models.Model):
    ...
    construction_year = models.IntegerField(
        ...
        blank=True,
        db_index=True)
    new_building = models.BooleanField(verbose_name='Новостройка?', db_index=True, blank=True, default=False)
...
class Owner(models.Model):
    ...
    flats = models.ManyToManyField(Flat, verbose_name='Квартиры в собственности', related_name='owned_by', db_index=True)
